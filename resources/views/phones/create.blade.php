        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Yeni Telefon Ekle</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('phones.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('marka') is-invalid @enderror" id="marka" name="marka" value="{{ old('marka') }}" required>
                            @error('marka')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('imei') is-invalid @enderror" id="imei" name="imei" value="{{ old('imei') }}" required>
                            @error('imei')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('seri_no') is-invalid @enderror" id="seri_no" name="seri_no" value="{{ old('seri_no') }}" required>
                            @error('seri_no')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('satis_tarihi') is-invalid @enderror" id="satis_tarihi" name="satis_tarihi" value="{{ old('satis_tarihi') }}" required>
                            @error('satis_tarihi')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
